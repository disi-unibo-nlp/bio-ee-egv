...
"""ConfigDict for T5-Base on Summarization."""
import sys
sys.path.append("..")
...
def get_config():
  ...
  config.mixture_or_task_name = 'summarization_task'
  ...
  config.eval_mixture_or_task_name = 'summarization_task'
